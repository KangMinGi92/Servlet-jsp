...
<body>
	...
	<p>일반숫자출력 : ${numtest }</p>
	<p>기본 fmt태그를 이용해서 출력 : <fmt:formatNumber value="${numtest }"/>원
	...
	<p>유로화로 표시 : <fmt:formatNumber value="${numtest1}" type="currency"/></p>
	...
	<h3><fmt:formatNumber value="123.123" maxFractionDigits="2"/></h3>
